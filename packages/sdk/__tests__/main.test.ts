...
const fakeValidatorAddress = '0x8f63d7dD6A3F5938616Ef06016BBf25BD6023315'.toLowerCase();
describe('SDK', () => {
    test('P256Lib', () => {
    ...
    test('packUserOpRS256Signature', async () => {
        ...
        const validatorSignature = '02'/*passkey without validationData*/ + '01'/* type=RS256 */ + "";
        const expectSignature =
            fakeValidatorAddress +
    ...
    test('packEOASignature', async () => {
        ...
        expect(signature.isOk()).toBe(true);
        const validatorSignature = '00'/*EOA without validationData*/ + rawSignature.slice(2);
        const expectSignature =
            fakeValidatorAddress +
    ...
    test('calcWalletAddressSalt', async () => {
        ...
        */
        ...
        expect(Hex.paddingZero(baseSalt + BigInt(0), 32)).toBe("0x5fe7f977e71dba2ea1a68e21057beebb9be2ac30c6410aa38d4f3fbe41dcffd2");
